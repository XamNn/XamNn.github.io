---
title: "Interp - an Interpreted Programming Language Pt.10 - REPL"
author: "Samuel Kriikkula"
tags: interp
---
Hey there! It's Pt. 9 and in this one we create a command line interface.
...
## Main
Let's redo main to support our REPL.
...
fn main() {
    ...
    match opt.source_file {
        ...
        None => {
            ...
            if rl.load_history(".interp-history.txt").is_err() { }
            for line_nr in 0.. {
            ...
            if rl.save_history(".interp-history.txt").is_err() { }
        }
    }
