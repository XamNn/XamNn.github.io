...
...
expr0: Expr = { // Previously just 'expr'
    "(" <expr> ")",
    string,
    int,
    float,
...
Your job is to make the 'sub', 'mul', and 'mod' functions. Don't forget to implement the DivByZero error aswell.

*src/vm/arithmetic.rs:*
```rust
use crate::vm::value::Value;
use crate::vm::expr_to_value;
use crate::err;
